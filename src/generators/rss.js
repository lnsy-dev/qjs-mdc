 ...
 * @param {string} _templatesDir - Unused; present for consistent generator signature
 * @param {Object} globalVars - Global variables from index.json
 * @param {Object} _assets - Unused; present for consistent generator signature
 */
export function generateRSSFeed(files, outputDir, _templatesDir, globalVars, _assets) {
  ...
  writeFile(`${outputDir}/rss.xml`, rss);
  console.log('✓ rss.xml');
}
